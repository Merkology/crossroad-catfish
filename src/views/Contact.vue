        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
            ...
            >
              ...
              <div class="ml-4 text-md tracking-wide font-semibold w-40">
                906 N State St, Clarksdale, MS 38614
              </div>
            </div>
          ...
          <form class="p-6 flex flex-col justify-center">
            ...
            <textarea
              id="message"
              rows="4"
              class="w-100 mt-4 py-3 block p-2.5 w-full text-sm text-gray-600 bg-gray-50 rounded-lg border border-gray-300 font-semibold focus:border-indigo-500 focus:outline-none dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500"
              placeholder="Your message..."
            ></textarea>

            <button
              type="submit"
              class="md:w-32 mt-4 bg-indigo-600 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-indigo-500 transition ease-in-out duration-300"
            >
              Submit
            </button>
          </form>
